...
| Objectif |  | Standard |
| Énoncé de la compétence |  | Contexte de réalisation |
| Reconnaître le rôle des mathématiques ou de l'informatique dans la société contemporaine. | - | Individuellement. |
...
| Éléments de la compétence |  | Critères de performance |
| 1. Démontrer l'acquisition de connaissances générales de base sur les mathématiques ou sur l'informatique. | - | Distinction de notions et de concepts de base. |
...
| 5. Évaluer l'influence des mathématiques ou de l'informatique sur les individus et sur les organisations. | - | Identification de quelques grandes influences. |
