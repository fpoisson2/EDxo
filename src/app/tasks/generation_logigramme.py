...
def generate_programme_logigramme_task(self, programme_id: int, user_id: int, form: dict):
    ...
    try:
        ...
        user_prompt = (
            ...
            "- Répartition temporelle: privilégier 'developpe' dans les sessions initiales, puis 'atteint' lorsque la compétence est consolidée en fin de parcours; 'reinvesti' sert à réutiliser des compétences déjà travaillées.\n\n"
